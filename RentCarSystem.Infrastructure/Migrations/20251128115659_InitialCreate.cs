        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentKilometer = table.Column<int>(type: "int", nullable: false),
                    ...
                    WeeklyPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    DailyKilometerLimit = table.Column<int>(type: "int", nullable: false),
                    ExtraKilometerFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraServicesFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    InsuranceFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ExtraKilometerFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FuelDifferenceFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    HasBabySeat = table.Column<bool>(type: "bit", nullable: false),
                    HasGPS = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupKilometer = table.Column<int>(type: "int", nullable: false),
                    FuelLevelAtPickup = table.Column<int>(type: "int", nullable: false),
                    ...
                    ReturnKilometer = table.Column<int>(type: "int", nullable: true),
                    FuelLevelAtReturn = table.Column<int>(type: "int", nullable: true),
                    ...
                    CustomerSignatureUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    StaffSignatureUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DamageReports_RentalAgreements_RentalAgreementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DamageImages_DamageReports_DamageReportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DamageImages_DamageReportId",
                table: "DamageImages",
                column: "DamageReportId");

            migrationBuilder.CreateIndex(
                name: "IX_DamageReports_RentalAgreementId",
                table: "DamageReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalAgreements_ContractNumber",
